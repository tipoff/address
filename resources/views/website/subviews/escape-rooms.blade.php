<section class="tger-escape-rooms">
    
    <svg 
        version="1.1" 
        class="escape-room-burst-right w-8" 
                    ...
                    <div class="">
                        <a href="{{ url($marketescapetheme->path) }}">
                            ...
                            <span>{{ $marketescapetheme->title }}<br>
                                @if ($marketescapetheme->duration == 120)
                                    <amp-img src="/img/icons/120-minutes.png" width="93" height="30" layout="intrinsic"></amp-img>
                                @elseif ($marketescapetheme->duration == 75)
                                    <amp-img src="/img/icons/75-minutes.png" width="84" height="30" layout="intrinsic"></amp-img>
                                @else
                                    <amp-img src="/img/icons/60-minutes.png" width="87" height="30" layout="intrinsic"></amp-img>
                                @endif
                            </span>
                        </a>
                    </div>
                        ...
                        <a href="{{ url($escapetheme->path) }}">
                            ...
                            <span>{{ $escapetheme->title }}<br>
                                @if ($escapetheme->duration == 120)
                                    <amp-img src="/img/icons/120-minutes.png" width="93" height="30" layout="intrinsic"></amp-img>
                                @elseif ($escapetheme->duration == 75)
                                    <amp-img src="/img/icons/75-minutes.png" width="84" height="30" layout="intrinsic"></amp-img>
                                @else
                                    <amp-img src="/img/icons/60-minutes.png" width="87" height="30" layout="intrinsic"></amp-img>
                                @endif
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <h3>Portable Escape Experience</h3>
                <p>Is your team ready for an out-of-the-box experience? For large corporate teams, we can bring the fun of escape rooms to your office.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-6 col-md-3 mb-5 mb-md-0">
                <a href="#">
                    <amp-img src="/img/escape/tger-otr-icon.png" height="300" width="300" layout="intrinsic" class="escape-room-icon"></amp-img>
