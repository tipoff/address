<header class="tger-website-header h-32">
     <nav class="flex justify-between h-full items-center">
          <div class="tger-website-header__navbar-left h-full flex items-center">
               ...
               <div class="header-desktop-locations">
                    ...
                    @else
                         <button class="button0 flex items-center" type="button" on="tap:menu">
                              <div>Locations</div>
                              <svg 
                                   version="1.1" 
          ...
          <div class="tger-website-header__navbar-right h-full flex items-center">
