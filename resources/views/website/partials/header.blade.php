<header class="tger-website-header">
     <nav class="tger-website-header__navbar">
          <div class="tger-website-header__navbar-container">
               <div class="tger-website-header__navbar-left">
                    <a class="tger-logo" href="{{ url('/') }}">
                         <svg 
                              data-name="Layer 1" 
               ...
               <div class="tger-website-header__navbar-right">
                    <a href="{{ $market->bookings_path ?? route('bookings') }}" class="button4 desktop-button" role="button">Book Online</a>

                    <a href="{{ $market->bookings_path ?? route('bookings') }}" class="button4 mobile-button" role="button">Book<br>Online</a>
